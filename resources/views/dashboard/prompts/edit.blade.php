...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card-dark p-4">
            <h5 class="fw-bold text-white mb-4"><i class="bi bi-pencil-square me-2" style="color:#7c3aed"></i>Edit Prompt</h5>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select form-select-dark">
                            <option value="public" {{ old('status', $prompt->status) == 'public' ? 'selected' : '' }}>Public</option>
                            <option value="private" {{ old('status', $prompt->status) == 'private' ? 'selected' : '' }}>Private</option>
                        </select>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 d-flex gap-3 pt-2">
                        <button type="submit" class="btn btn-gradient px-4">
                            <i class="bi bi-check2 me-2"></i>Update Prompt
                        </button>

    ...
    <div class="col-lg-6">
        <div class="card-dark p-4">
            <h5 class="fw-bold text-white mb-4">
                <i class="bi bi-folder-symlink me-2" style="color:#f59e0b"></i>Edit Category
            </h5>
            <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted mt-1" style="font-size:0.78rem">Current slug: <code style="color:#a78bfa">{{ $category->slug }}</code></p>
                </div>
                <div class="mb-4">

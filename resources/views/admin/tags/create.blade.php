...
@section('title', __('new_tag_title'))
@section('page-title', __('new_tag_title'))
@section('content')
    ...
    <div class="col-lg-5">
        <div class="card-dark p-4">
            <h5 class="fw-bold text-white mb-4">
                <i class="bi bi-tag me-2" style="color:#ec4899"></i>{{ __('new_tag_title') }}
            </h5>
